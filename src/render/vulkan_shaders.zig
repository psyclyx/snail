...
const raw_frag_sp = @embedFile("snail_subpixel.frag.spv");
const raw_frag_sp_dual = @embedFile("snail_subpixel_dual.frag.spv");
...
const aligned_frag_sp_dual: [raw_frag_sp_dual.len]u8 align(4) = raw_frag_sp_dual.*;
...
pub const frag_subpixel_dual_spv: []align(4) const u8 = &aligned_frag_sp_dual;
