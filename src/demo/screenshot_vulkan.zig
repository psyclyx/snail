//! Vulkan counterpart to `screenshot.zig`. Renders the shared
//! content (see `content.zig`) through the Vulkan upload +
//! draw path and writes `zig-out/demo-screenshot-vulkan.tga`.
