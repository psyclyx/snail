...
const raw_frag_path_quadratic_native = @embedFile("snail_path_quadratic_native.frag.spv");
const raw_frag_path_conic_native = @embedFile("snail_path_conic_native.frag.spv");
...
const aligned_frag_path_quadratic_native: [raw_frag_path_quadratic_native.len]u8 align(4) = raw_frag_path_quadratic_native.*;
const aligned_frag_path_conic_native: [raw_frag_path_conic_native.len]u8 align(4) = raw_frag_path_conic_native.*;
...
pub const frag_path_quadratic_native_spv: []align(4) const u8 = &aligned_frag_path_quadratic_native;
pub const frag_path_conic_native_spv: []align(4) const u8 = &aligned_frag_path_conic_native;
