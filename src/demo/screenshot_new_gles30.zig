//! GLES3 counterpart to `screenshot_new.zig`. Renders the shared
//! content (see `new_content.zig`) through the new-API GLES3 upload +
//! draw path and writes `zig-out/demo-screenshot-new-gles30.tga`.
...
const W: u32 = 400;
const H: u32 = 240;
const OUT_PATH = "zig-out/demo-screenshot-new-gles30.tga";
...
pub fn main() !void {
    ...
    var gl_ctx = try egl_offscreen.Context.init(W, H, .gles30);
    defer gl_ctx.deinit();
