//! GLES30 counterpart to `screenshot_new.zig`. Renders the same
//! Picture content through the new-API GLES3 upload + draw path
//! (Phase 5b) and writes `zig-out/demo-screenshot-new-gles30.tga`.
