//! GL counterpart to `screenshot_new.zig`. Renders the shared content
//! (see `new_content.zig`) through the new-API GL upload + draw path
//! and writes `zig-out/demo-screenshot-new-gl.tga`.
