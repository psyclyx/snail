//! GLES3 counterpart to `screenshot.zig`. Renders the shared
//! content (see `content.zig`) through the GLES3 upload +
//! draw path and writes `zig-out/demo-screenshot-gles30.tga`.
...
const W: u32 = 400;
const H: u32 = 240;
const OUT_PATH = "zig-out/demo-screenshot-gles30.tga";
