...
pub const SnailSourceRange = c_types.SnailSourceRange;
pub const SnailOpenTypeFeature = c_types.SnailOpenTypeFeature;
pub const SnailShapeOptions = c_types.SnailShapeOptions;
pub const SnailCluster = c_types.SnailCluster;
pub const SnailClusterIterator = c_types.SnailClusterIterator;
...
pub const GlyphHintSnapshotImpl = c_handles.GlyphHintSnapshotImpl;
