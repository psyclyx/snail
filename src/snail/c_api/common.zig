...
pub const SnailGlesTextCoverageProgram = c_types.SnailGlesTextCoverageProgram;
...
pub const toGlCoverageProgram = c_convert.toGlCoverageProgram;
pub const toGlesCoverageProgram = c_convert.toGlesCoverageProgram;
...
pub const TextBlobBuilderImpl = c_handles.TextBlobBuilderImpl;
