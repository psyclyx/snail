...
const PreparedAxisCurveCold = cpu_coverage.PreparedAxisCurveCold;
const PreparedAxisCurve = cpu_coverage.PreparedAxisCurve;
...
const decodeCurveSegmentFromSlice = cpu_texture.decodeCurveSegmentFromSlice;
...
const prepareAxisCurve = cpu_coverage.prepareAxisCurve;
const preparePathLayerInfoRecords = cpu_path_paint.preparePathLayerInfoRecords;
const PreparedPathPaint = cpu_path_paint.PreparedPathPaint;
const PreparedPathRecord = cpu_path_paint.PreparedPathRecord;
const ResolvedLayerInfo = cpu_path_paint.ResolvedLayerInfo;
const readBandCurveBase = cpu_texture.readBandCurveBase;
