...
void main()
{
    highp vec4 _12862 = snail_io4;
    highp vec2 _12863 = snail_io1;
    highp vec4 _12864 = snail_io2;
    ivec4 _12865 = snail_io3;
    int _12870 = pc.layer_base;
    int _12871 = pc.output_srgb;
    highp float _12872 = pc.coverage_exponent;
    highp float _12873 = pc.dither_scale;
    int _12874 = pc.mask_output;
    highp vec4 _3237;
    do
    {
        highp vec2 _3383 = fwidth(_12863);
        highp vec2 _3248 = vec2(1.0) / max(_3383, vec2(1.52587890625e-05));
        ...
        highp vec4 _3265 = texelFetch(SPIRV_Cross_Combinedu_layer_texSPIRV_Cross_DummySampler, ivec3(_12865.xy, 0).xy, 0);
        highp float _3267 = _3265.w;
        if (_3267 >= 0.0)
        {
            discard;
        }
        ...
        if (int(0.5 - _3267) == 5)
        {
            ...
            highp vec4 _3384 = vec4(0.0);
            highp float _3385 = 0.0;
            highp float _3386 = 0.0;
            highp vec4 _12773 = vec4(0.0);
            highp float _12774 = 0.0;
            highp vec4 _12788 = vec4(0.0);
            highp float _12789 = 0.0;
            highp float _3387 = 0.0;
            int _3390 = 0;
            bool _3391;
            bool _3393;
            highp float _3394;
            ...
            for (;;)
            {
                ...
                do
                {
                    ...
                    highp vec4 _3423 = texelFetch(SPIRV_Cross_Combinedu_layer_texSPIRV_Cross_DummySampler, ivec3(_3580, 0).xy, 0);
                    ...
                    highp vec4 _3429 = texelFetch(SPIRV_Cross_Combinedu_layer_texSPIRV_Cross_DummySampler, ivec3(ivec2(_3595 - _3590 * (_3595 / _3590), _3595 / _3590), 0).xy, 0);
                    ...
                    highp float _3603 = _3429.y;
                    highp float _3641 = (_12863.y * _3603) + _3429.w;
                    highp float _3645 = max(abs(_3383.y * _3603) * 0.5, 9.9999997473787516355514526367188e-06);
                    int _3648 = clamp(int(_3641 - _3645), 0, _3441);
                    int _3652 = max(_3648, clamp(int(_3641 + _3645), 0, _3441));
                    highp float _3609 = _3429.x;
                    highp float _3663 = (_12863.x * _3609) + _3429.z;
                    highp float _3667 = max(abs(_3383.x * _3609) * 0.5, 9.9999997473787516355514526367188e-06);
                    int _3670 = clamp(int(_3663 - _3667), 0, _3443);
                    int _3674 = max(_3670, clamp(int(_3663 + _3667), 0, _3443));
                    highp float _3613 = _3248.x;
                    highp float _3682 = 0.0;
                    highp float _3683 = 0.0;
                    ...
                    for (;;)
                    {
                        ...
                        for (;;)
                        {
                            ...
                            do
                            {
                                ...
                                highp vec4 _3834 = texelFetch(SPIRV_Cross_Combinedu_curve_texSPIRV_Cross_DummySampler, ivec4(_3822, _3277, 0).xyz, 0);
                                int _3872 = _3822.x + 1;
                                ivec2 _3874 = ivec2(_3872, _3822.y);
                                _3874.y = _3874.y + (_3872 >> 12);
                                _3874.x = _3874.x & 4095;
                                highp vec4 _3840 = texelFetch(SPIRV_Cross_Combinedu_curve_texSPIRV_Cross_DummySampler, ivec4(_3874, _3277, 0).xyz, 0);
                                int _12679 = _3827;
                                highp vec2 _12680 = _3834.xy;
                                highp vec2 _12681 = _3834.zw;
                                highp vec2 _12682 = _3840.xy;
                                highp vec2 _12683 = _3840.zw;
                                if (_3827 == 1)
                                {
                                    int _3887 = _3822.x + 2;
                                ...
                                int _12711 = _12679;
                                highp vec2 _12712 = _12680;
                                highp vec2 _12713 = _12681;
                                highp vec2 _12714 = _12682;
                                highp vec2 _12715 = _12683;
                                highp vec3 _12716 = _12684;
                                do
                                {
                                    if (true)
                                    {
                                    ...
                                    if (_12711 == 0)
                                    {
                                        highp float _3946 = _12712.x - _12863.x;
                                        highp float _3949 = _12712.y - _12863.y;
                                        highp float _3953 = _12713.x - _12863.x;
                                        highp float _3955 = _12713.y - _12863.y;
                                        highp float _3959 = _12714.x - _12863.x;
                                        highp float _3961 = _12714.y - _12863.y;
                                        if (true)
                                        {
                                        ...
                                        if (true)
                                        {
                                            highp float _4903 = (_3946 - (_3953 * 2.0)) + _3959;
                                            highp float _4906 = (_3949 - (_3955 * 2.0)) + _3961;
                                            highp float _4908 = _3949 - _3955;
                                            ...
                                            {
                                                highp float _4913 = _4906 * _3949;
                                                highp float _4914 = (_4908 * _4908) - _4913;
                                                ...
                                                else
                                                {
                                                    ...
                                                    highp float _4926 = _4897;
                                                    _4897 = _4918 / _4906;
                                                    _4898 = _4926;
                                                }
                                            }
                                            highp float _4949 = (_3946 - _3953) * 2.0;
                                            _3902 = vec2(((((_4903 * _4897) - _4949) * _4897) + _3946) * _3613, ((((_4903 * _4898) - _4949) * _4898) + _3946) * _3613);
                                        }
                                        else
                                        {
                                            highp float _4824 = (_3946 - (_3953 * 2.0)) + _3959;
                                            highp float _4827 = (_3949 - (_3955 * 2.0)) + _3961;
                                            highp float _4828 = _3946 - _3953;
                                            ...
                                            {
                                                highp float _4834 = _4824 * _3946;
                                                highp float _4835 = (_4828 * _4828) - _4834;
                                                ...
                                                else
                                                {
                                                    ...
                                                    highp float _4847 = _4818;
                                                    _4818 = _4839 / _4824;
                                                    _4819 = _4847;
                                                }
                                            }
                                            highp float _4870 = (_3949 - _3955) * 2.0;
                                    ...
                                    if (_12711 == 3)
                                    {
                                        highp float _4026 = _12712.x - _12863.x;
                                        highp float _4029 = _12712.y - _12863.y;
                                        highp float _4033 = _12714.x - _12863.x;
                                        highp float _4035 = _12714.y - _12863.y;
                                        do
                                        {
                                            if (true)
                                            {
                                            ...
                                            highp float _4055 = _3904 - _3903;
                                            if (abs(_4055) < 1.0000000133514319600180897396058e-10)
                                            {
                                                break;
                                            }
                                            highp float _4063 = clamp((-_3903) / _4055, 0.0, 1.0);
                                            if (true)
                                            {
                                                _3905 = _4035 - _4029;
                                            }
                                            ...
                                            highp float _4083 = _3900;
                                            highp float _4084 = _4083 * _3613;
                                            if (_3905 > 0.0)
                                            {
                                                _3900 = 1.0;
                                            }
                                    ...
                                    if (_12711 == 1)
                                    {
                                        do
                                        {
                                            ...
                                            highp float _4182 = _12716.x * (_3905 - _3903);
                                            highp float _4187 = _12716.y * (_3906 - _3903);
                                            highp float _4192 = _12716.z * (_3907 - _3903);
                                            ...
                                            highp float _4203 = (_4182 - (2.0 * _4187)) + _4192;
                                            highp float _4204 = _4187 - _4182;
                                            highp float _4205 = 2.0 * _4204;
                                            if (abs(_4203) < 1.52587890625e-05)
                                            {
                                                ...
                                                highp float _4229 = _3908;
                                                _3908 = 0.0;
                                                _3912 = _4229;
                                            }
                                            else
                                            {
                                                highp float _4214 = sqrt(max((_4205 * _4205) - ((4.0 * _4203) * _4182), 0.0));
                                                highp float _4215 = 0.5 / _4203;
                                                highp float _4216 = _4204 * (-2.0);
                                                _3916 = 2;
                                            ...
                                            highp float _4263 = _3905 * _12716.x;
                                            highp float _4270 = (_4263 - ((2.0 * _3906) * _12716.y)) + (_3907 * _12716.z);
                                            highp float _4274 = 2.0 * ((_3906 * _12716.y) - _4263);
                                            highp float _4276 = _3909 * _12716.x;
                                            highp float _4283 = (_4276 - ((2.0 * _3910) * _12716.y)) + (_3911 * _12716.z);
                                            highp float _4287 = 2.0 * ((_3910 * _12716.y) - _4276);
                                            highp float _4290 = (_12716.x - (2.0 * _12716.y)) + _12716.z;
                                            highp float _4292 = 2.0 * (_12716.y - _12716.x);
                                            highp float _4315;
                                            highp float _4319;
                                            do
                                            {
                                                highp float _4301 = max((((_4290 * _3913) + _4292) * _3913) + _12716.x, 1.52587890625e-05);
                                                _4315 = 2.0 * _4270;
                                                _4319 = 2.0 * _4290;
                                                highp float _4327 = ((((_4315 * _3913) + _4274) * _4301) - (((((_4270 * _3913) + _4274) * _3913) + _4263) * ((_4319 * _3913) + _4292))) / (_4301 * _4301);
                                                if (false)
                                                {
                                                    _3919 = -_4327;
                                                }
                                                ...
                                                highp float _4340 = ((((((_4283 * _3913) + _4287) * _3913) + _4276) / _4301) - _3904) * _3613;
                                                if (_3919 > 0.0)
                                                {
                                                    _3900 = 1.0;
                                                }
                                            ...
                                            if (_3917 == 2)
                                            {
                                                do
                                                {
                                                    highp float _4370 = max((((_4290 * _3914) + _4292) * _3914) + _12716.x, 1.52587890625e-05);
                                                    highp float _4394 = ((((_4315 * _3914) + _4274) * _4370) - (((((_4270 * _3914) + _4274) * _3914) + _4263) * ((_4319 * _3914) + _4292))) / (_4370 * _4370);
                                                    if (false)
                                                    {
                                                        _3919 = -_4394;
                                                    }
                                                    ...
                                                    highp float _4406 = ((((((_4283 * _3914) + _4287) * _3914) + _4276) / _4370) - _3904) * _3613;
                                                    if (_3919 > 0.0)
                                                    {
                                                        _3900 = 1.0;
                                                    }
                                    ...
                                    do
                                    {
                                        ...
                                        highp float _4519 = 3.0 * _3906;
                                        highp float _4522 = 3.0 * _3907;
                                        highp float _4525 = ((_4519 - _3905) - _4522) + _3908;
                                        highp float _4531 = ((3.0 * _3905) - (6.0 * _3906)) + _4522;
                                        highp float _4534 = ((-3.0) * _3905) + _4519;
                                        highp float _4537 = _3905 - _3903;
                                        highp float _4540 = _3908 - _3903;
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                do
                                                {
                                                    ...
                                                    highp float _5329 = 0.5;
                                                    highp float _5330 = 0.0;
                                                    highp float _5331 = 1.0;
                                                    int _5332 = 0;
                                                    for (;;)
                                                    {
                                                        if (!(_5332 < 16))
                                                        ...
                                                        highp float _5373 = (((((_4525 * _5329) + _4531) * _5329) + _4534) * _5329) + _4537;
                                                        if (_5356)
                                                        {
                                                            _5328 = _5373 < 0.0;
                                                        }
                                                        ...
                                                        highp float _5400 = ((((3.0 * _4525) * _5329) + (2.0 * _4531)) * _5329) + _4534;
                                                        highp float _5404 = (_5330 + _5331) * 0.5;
                                                        if (abs(_5400) >= 9.9999999747524270787835121154785e-07)
                                                        {
                                                            highp float _5411 = _5329 - (_5373 / _5400);
                                                            if (_5411 > _5330)
                                                            {
                                                                _5335 = _5411 < _5331;
                                                            }
                                        ...
                                        highp float _4565 = 3.0 * _3910;
                                        highp float _4568 = 3.0 * _3911;
                                        if (_3920 == 1.0)
                                        {
                                            _3913 = _3912;
                                        }
                                        ...
                                        highp float _4609 = (_3913 - _3904) * _3613;
                                        if (_3914 > 0.0)
                                        {
                                            _3900 = 1.0;
                                        }
                    ...
                    highp vec2 _3760 = vec2(_3682, _3683);
                    highp float _3617 = _3248.y;
                    int _3618 = _3441 + 1;
                    highp float _5434 = 0.0;
                    highp float _5435 = 0.0;
                    ...
                    for (;;)
                    {
                        ...
                        for (;;)
                        {
                            ...
                            do
                            {
                                ...
                                highp vec4 _5586 = texelFetch(SPIRV_Cross_Combinedu_curve_texSPIRV_Cross_DummySampler, ivec4(_5574, _3277, 0).xyz, 0);
                                int _5624 = _5574.x + 1;
                                ivec2 _5626 = ivec2(_5624, _5574.y);
                                _5626.y = _5626.y + (_5624 >> 12);
                                _5626.x = _5626.x & 4095;
                                highp vec4 _5592 = texelFetch(SPIRV_Cross_Combinedu_curve_texSPIRV_Cross_DummySampler, ivec4(_5626, _3277, 0).xyz, 0);
                                int _12635 = _5579;
                                highp vec2 _12636 = _5586.xy;
                                highp vec2 _12637 = _5586.zw;
                                highp vec2 _12638 = _5592.xy;
                                highp vec2 _12639 = _5592.zw;
                                if (_5579 == 1)
                                {
                                    int _5639 = _5574.x + 2;
                                ...
                                int _12667 = _12635;
                                highp vec2 _12668 = _12636;
                                highp vec2 _12669 = _12637;
                                highp vec2 _12670 = _12638;
                                highp vec2 _12671 = _12639;
                                highp vec3 _12672 = _12640;
                                do
                                {
                                    if (false)
                                    {
                                    ...
                                    if (_12667 == 0)
                                    {
                                        highp float _5698 = _12668.x - _12863.x;
                                        highp float _5701 = _12668.y - _12863.y;
                                        highp float _5705 = _12669.x - _12863.x;
                                        highp float _5707 = _12669.y - _12863.y;
                                        highp float _5711 = _12670.x - _12863.x;
                                        highp float _5713 = _12670.y - _12863.y;
                                        if (false)
                                        {
                                        ...
                                        if (false)
                                        {
                                            highp float _6655 = (_5698 - (_5705 * 2.0)) + _5711;
                                            highp float _6658 = (_5701 - (_5707 * 2.0)) + _5713;
                                            highp float _6660 = _5701 - _5707;
                                            ...
                                            {
                                                highp float _6665 = _6658 * _5701;
                                                highp float _6666 = (_6660 * _6660) - _6665;
                                                ...
                                                else
                                                {
                                                    ...
                                                    highp float _6678 = _6649;
                                                    _6649 = _6670 / _6658;
                                                    _6650 = _6678;
                                                }
                                            }
                                            highp float _6701 = (_5698 - _5705) * 2.0;
                                            _5654 = vec2(((((_6655 * _6649) - _6701) * _6649) + _5698) * _3617, ((((_6655 * _6650) - _6701) * _6650) + _5698) * _3617);
                                        }
                                        else
                                        {
                                            highp float _6576 = (_5698 - (_5705 * 2.0)) + _5711;
                                            highp float _6579 = (_5701 - (_5707 * 2.0)) + _5713;
                                            highp float _6580 = _5698 - _5705;
                                            ...
                                            {
                                                highp float _6586 = _6576 * _5698;
                                                highp float _6587 = (_6580 * _6580) - _6586;
                                                ...
                                                else
                                                {
                                                    ...
                                                    highp float _6599 = _6570;
                                                    _6570 = _6591 / _6576;
                                                    _6571 = _6599;
                                                }
                                            }
                                            highp float _6622 = (_5701 - _5707) * 2.0;
                                    ...
                                    if (_12667 == 3)
                                    {
                                        highp float _5778 = _12668.x - _12863.x;
                                        highp float _5781 = _12668.y - _12863.y;
                                        highp float _5785 = _12670.x - _12863.x;
                                        highp float _5787 = _12670.y - _12863.y;
                                        do
                                        {
                                            if (false)
                                            {
                                            ...
                                            highp float _5807 = _5656 - _5655;
                                            if (abs(_5807) < 1.0000000133514319600180897396058e-10)
                                            {
                                                break;
                                            }
                                            highp float _5815 = clamp((-_5655) / _5807, 0.0, 1.0);
                                            if (false)
                                            {
                                                _5657 = _5787 - _5781;
                                            }
                                            ...
                                            highp float _5835 = _5652;
                                            highp float _5836 = _5835 * _3617;
                                            if (_5657 > 0.0)
                                            {
                                                _5652 = 1.0;
                                            }
                                    ...
                                    if (_12667 == 1)
                                    {
                                        do
                                        {
                                            ...
                                            highp float _5934 = _12672.x * (_5657 - _5655);
                                            highp float _5939 = _12672.y * (_5658 - _5655);
                                            highp float _5944 = _12672.z * (_5659 - _5655);
                                            ...
                                            highp float _5955 = (_5934 - (2.0 * _5939)) + _5944;
                                            highp float _5956 = _5939 - _5934;
                                            highp float _5957 = 2.0 * _5956;
                                            if (abs(_5955) < 1.52587890625e-05)
                                            {
                                                ...
                                                highp float _5981 = _5660;
                                                _5660 = 0.0;
                                                _5664 = _5981;
                                            }
                                            else
                                            {
                                                highp float _5966 = sqrt(max((_5957 * _5957) - ((4.0 * _5955) * _5934), 0.0));
                                                highp float _5967 = 0.5 / _5955;
                                                highp float _5968 = _5956 * (-2.0);
                                                _5668 = 2;
                                            ...
                                            highp float _6015 = _5657 * _12672.x;
                                            highp float _6022 = (_6015 - ((2.0 * _5658) * _12672.y)) + (_5659 * _12672.z);
                                            highp float _6026 = 2.0 * ((_5658 * _12672.y) - _6015);
                                            highp float _6028 = _5661 * _12672.x;
                                            highp float _6035 = (_6028 - ((2.0 * _5662) * _12672.y)) + (_5663 * _12672.z);
                                            highp float _6039 = 2.0 * ((_5662 * _12672.y) - _6028);
                                            highp float _6042 = (_12672.x - (2.0 * _12672.y)) + _12672.z;
                                            highp float _6044 = 2.0 * (_12672.y - _12672.x);
                                            highp float _6067;
                                            highp float _6071;
                                            do
                                            {
                                                highp float _6053 = max((((_6042 * _5665) + _6044) * _5665) + _12672.x, 1.52587890625e-05);
                                                _6067 = 2.0 * _6022;
                                                _6071 = 2.0 * _6042;
                                                highp float _6079 = ((((_6067 * _5665) + _6026) * _6053) - (((((_6022 * _5665) + _6026) * _5665) + _6015) * ((_6071 * _5665) + _6044))) / (_6053 * _6053);
                                                if (true)
                                                {
                                                    _5671 = -_6079;
                                                }
                                                ...
                                                highp float _6092 = ((((((_6035 * _5665) + _6039) * _5665) + _6028) / _6053) - _5656) * _3617;
                                                if (_5671 > 0.0)
                                                {
                                                    _5652 = 1.0;
                                                }
                                            ...
                                            if (_5669 == 2)
                                            {
                                                do
                                                {
                                                    highp float _6122 = max((((_6042 * _5666) + _6044) * _5666) + _12672.x, 1.52587890625e-05);
                                                    highp float _6146 = ((((_6067 * _5666) + _6026) * _6122) - (((((_6022 * _5666) + _6026) * _5666) + _6015) * ((_6071 * _5666) + _6044))) / (_6122 * _6122);
                                                    if (true)
                                                    {
                                                        _5671 = -_6146;
                                                    }
                                                    ...
                                                    highp float _6158 = ((((((_6035 * _5666) + _6039) * _5666) + _6028) / _6122) - _5656) * _3617;
                                                    if (_5671 > 0.0)
                                                    {
                                                        _5652 = 1.0;
                                                    }
                                    ...
                                    do
                                    {
                                        ...
                                        highp float _6271 = 3.0 * _5658;
                                        highp float _6274 = 3.0 * _5659;
                                        highp float _6277 = ((_6271 - _5657) - _6274) + _5660;
                                        highp float _6283 = ((3.0 * _5657) - (6.0 * _5658)) + _6274;
                                        highp float _6286 = ((-3.0) * _5657) + _6271;
                                        highp float _6289 = _5657 - _5655;
                                        highp float _6292 = _5660 - _5655;
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                do
                                                {
                                                    ...
                                                    highp float _7081 = 0.5;
                                                    highp float _7082 = 0.0;
                                                    highp float _7083 = 1.0;
                                                    int _7084 = 0;
                                                    for (;;)
                                                    {
                                                        if (!(_7084 < 16))
                                                        ...
                                                        highp float _7125 = (((((_6277 * _7081) + _6283) * _7081) + _6286) * _7081) + _6289;
                                                        if (_7108)
                                                        {
                                                            _7080 = _7125 < 0.0;
                                                        }
                                                        ...
                                                        highp float _7152 = ((((3.0 * _6277) * _7081) + (2.0 * _6283)) * _7081) + _6286;
                                                        highp float _7156 = (_7082 + _7083) * 0.5;
                                                        if (abs(_7152) >= 9.9999999747524270787835121154785e-07)
                                                        {
                                                            highp float _7163 = _7081 - (_7125 / _7152);
                                                            if (_7163 > _7082)
                                                            {
                                                                _7087 = _7163 < _7083;
                                                            }
                                        ...
                                        highp float _6317 = 3.0 * _5662;
                                        highp float _6320 = 3.0 * _5663;
                                        if (_5672 == 1.0)
                                        {
                                            _5665 = _5664;
                                        }
                                        ...
                                        highp float _6361 = (_5665 - _5656) * _3617;
                                        if (_5666 > 0.0)
                                        {
                                            _5652 = 1.0;
                                        }
                    ...
                    highp vec2 _5512 = vec2(_5434, _5435);
                    highp float _3622 = _3760.y;
                    highp float _3623 = _5512.y;
                    highp float _3625 = _3760.x;
                    highp float _3627 = _5512.x;
                    highp float _3631 = ((_3625 * _3622) + (_3627 * _3623)) / max(_3622 + _3623, 1.52587890625e-05);
                    do
                    {
                        if (_3438 == 1)
                        {
                    ...
                    highp float _7240 = clamp(max(_7187, min(_7204, _7221)), 0.0, 1.0);
                    highp float _7241 = max(_12872, 1.52587890625e-05);
                    ...
                    do
                    {
                        ...
                        highp vec4 _7264 = texelFetch(SPIRV_Cross_Combinedu_layer_texSPIRV_Cross_DummySampler, ivec3(ivec2(_7396 - _7391 * (_7396 / _7391), _7396 / _7391), 0).xy, 0);
                        if (_7259 == 1)
                        {
                            _12611 = _7264;
                            _12612 = 0.0;
                        ...
                        highp vec4 _7274 = texelFetch(SPIRV_Cross_Combinedu_layer_texSPIRV_Cross_DummySampler, ivec3(ivec2(_7420 - _7415 * (_7420 / _7415), _7420 / _7415), 0).xy, 0);
                        ...
                        highp vec4 _7280 = texelFetch(SPIRV_Cross_Combinedu_layer_texSPIRV_Cross_DummySampler, ivec3(ivec2(_7438 - _7433 * (_7438 / _7433), _7438 / _7433), 0).xy, 0);
                        if (_7259 == 2)
                        {
                            highp vec2 _7285 = _7264.xy;
                            highp vec2 _7286 = _7264.zw - _7285;
                            highp float _7287 = dot(_7286, _7286);
                            ...
                            do
                            {
                                ...
                                if (_7467 == 2)
                                {
                                    highp float _7477 = _7252 - (2.0 * floor(_7252 * 0.5));
                                    if (_7477 < 0.0)
                                    {
                                        _7462 = _7477 + 2.0;
                                    }
                        ...
                        if (_7259 == 3)
                        {
                            highp float _7315 = length(_12863 - _7264.xy) / max(abs(_7264.z), 1.52587890625e-05);
                            do
                            {
                                ...
                                if (_7508 == 2)
                                {
                                    highp float _7518 = _7315 - (2.0 * floor(_7315 * 0.5));
                                    if (_7518 < 0.0)
                                    {
                                        _7503 = _7518 + 2.0;
                                    }
                        ...
                        if (_7259 == 6)
                        {
                            highp vec2 _7324 = _12863 - _7264.xy;
                            highp float _7329 = atan(_7324.y, _7324.x) - _7264.z;
                            highp float _7330 = _7329 * 0.15915493667125701904296875;
                            do
                            {
                                ...
                                if (_7549 == 2)
                                {
                                    highp float _7559 = _7330 - (2.0 * floor(_7329 * 0.079577468335628509521484375));
                                    if (_7559 < 0.0)
                                    {
                                        _7544 = _7559 + 2.0;
                                    }
                        ...
                        if (_7259 == 4)
                        {
                            ...
                            highp vec4 _7342 = texelFetch(SPIRV_Cross_Combinedu_layer_texSPIRV_Cross_DummySampler, ivec3(ivec2(_7597 - _7592 * (_7597 / _7592), _7597 / _7592), 0).xy, 0);
                            ...
                            highp vec4 _7348 = texelFetch(SPIRV_Cross_Combinedu_layer_texSPIRV_Cross_DummySampler, ivec3(ivec2(_7615 - _7610 * (_7615 / _7610), _7615 / _7610), 0).xy, 0);
                            highp vec3 _7350 = vec3(_12863, 1.0);
                            highp float _7355 = dot(_7350, vec3(_7264.xyz));
                            highp float _7360 = dot(_7350, vec3(_7342.xyz));
                            do
                            {
                                ...
                                if (_7626 == 2)
                                {
                                    highp float _7636 = _7355 - (2.0 * floor(_7355 * 0.5));
                                    if (_7636 < 0.0)
                                    {
                                        _7621 = _7636 + 2.0;
                                    }
                            ...
                            do
                            {
                                ...
                                if (_7657 == 2)
                                {
                                    highp float _7667 = _7360 - (2.0 * floor(_7360 * 0.5));
                                    if (_7667 < 0.0)
                                    {
                                        _7652 = _7667 + 2.0;
                                    }
                            ...
                            highp vec2 _7369 = vec2(_7620 * _7348.x, _7651 * _7348.y);
                    ...
                    highp float _12804 = _12612;
                    highp vec4 _12803 = _12611 * _12862;
                    if (_3406 == 1)
                    {
                        _3391 = _3403 >= 2;
                    }
                    ...
                    highp float _7736 = _12803.w * _7237;
                    highp vec4 _7739 = vec4(_12803.xyz * _7736, _7736);
                    highp float _3498 = _3394;
            ...
            if (_3391)
            {
                highp float _3516 = min(_3385, _3386);
                highp float _3519 = max(_3385 - _3516, 0.0);
                if (_12774 > 0.5)
                {
                ...
                highp float _7743 = _12773.w * _3519;
                highp float _7750 = _12788.w * _3516;
            ...
            if (_3387 > 0.5)
            {
                ...
                do
                {
                    ...
                    highp float _7798 = max(_3384.x, 0.0);
                    highp float _7807;
                    ...
                    highp float _7801 = max(_3384.y, 0.0);
                    highp float _7819;
                    ...
                    highp float _7804 = max(_3384.z, 0.0);
                    highp float _7831;
                    ...
                    highp vec3 _7784 = clamp(vec3(_7807, _7819, _7831) + vec3((fract(52.98291778564453125 * fract(dot(gl_FragCoord.xy, vec2(0.067110560834407806396484375, 0.005837149918079376220703125)))) - 0.5) * (clamp(_3384.w, 0.0, 1.0) * _12873)), vec3(0.0), vec3(1.0));
                    highp float _7845 = _7784.x;
                    highp float _7852;
            ...
            else
            {
                if (_12871 != 0)
                {
                    ...
                    do
                    {
                        ...
                        highp vec3 _7899 = _3238.xyz * (1.0 / _3238.w);
                        highp float _7908 = max(_7899.x, 0.0);
                        highp float _7917;
                        ...
                        highp float _7911 = max(_7899.y, 0.0);
                        highp float _7929;
                        ...
                        highp float _7914 = max(_7899.z, 0.0);
                        highp float _7941;
        ...
        highp vec4 _3323 = texelFetch(SPIRV_Cross_Combinedu_layer_texSPIRV_Cross_DummySampler, ivec3(ivec2(_7967 - _7962 * (_7967 / _7962), _7967 / _7962), 0).xy, 0);
        ...
        highp float _7975 = _3323.y;
        highp float _8013 = (_12863.y * _7975) + _3323.w;
        highp float _8017 = max(abs(_3383.y * _7975) * 0.5, 9.9999997473787516355514526367188e-06);
        int _8020 = clamp(int(_8013 - _8017), 0, _3335);
        int _8024 = max(_8020, clamp(int(_8013 + _8017), 0, _3335));
        highp float _7981 = _3323.x;
        highp float _8035 = (_12863.x * _7981) + _3323.z;
        highp float _8039 = max(abs(_3383.x * _7981) * 0.5, 9.9999997473787516355514526367188e-06);
        int _8042 = clamp(int(_8035 - _8039), 0, _3337);
        int _8046 = max(_8042, clamp(int(_8035 + _8039), 0, _3337));
        highp float _7985 = _3248.x;
        highp float _8054 = 0.0;
        highp float _8055 = 0.0;
        ...
        for (;;)
        {
            ...
            for (;;)
            {
                ...
                do
                {
                    ...
                    highp vec4 _8206 = texelFetch(SPIRV_Cross_Combinedu_curve_texSPIRV_Cross_DummySampler, ivec4(_8194, _3277, 0).xyz, 0);
                    int _8244 = _8194.x + 1;
                    ivec2 _8246 = ivec2(_8244, _8194.y);
                    _8246.y = _8246.y + (_8244 >> 12);
                    _8246.x = _8246.x & 4095;
                    highp vec4 _8212 = texelFetch(SPIRV_Cross_Combinedu_curve_texSPIRV_Cross_DummySampler, ivec4(_8246, _3277, 0).xyz, 0);
                    int _12445 = _8199;
                    highp vec2 _12446 = _8206.xy;
                    highp vec2 _12447 = _8206.zw;
                    highp vec2 _12448 = _8212.xy;
                    highp vec2 _12449 = _8212.zw;
                    if (_8199 == 1)
                    {
                        int _8259 = _8194.x + 2;
                    ...
                    int _12477 = _12445;
                    highp vec2 _12478 = _12446;
                    highp vec2 _12479 = _12447;
                    highp vec2 _12480 = _12448;
                    highp vec2 _12481 = _12449;
                    highp vec3 _12482 = _12450;
                    do
                    {
                        if (true)
                        {
                        ...
                        if (_12477 == 0)
                        {
                            highp float _8318 = _12478.x - _12863.x;
                            highp float _8321 = _12478.y - _12863.y;
                            highp float _8325 = _12479.x - _12863.x;
                            highp float _8327 = _12479.y - _12863.y;
                            highp float _8331 = _12480.x - _12863.x;
                            highp float _8333 = _12480.y - _12863.y;
                            if (true)
                            {
                            ...
                            if (true)
                            {
                                highp float _9275 = (_8318 - (_8325 * 2.0)) + _8331;
                                highp float _9278 = (_8321 - (_8327 * 2.0)) + _8333;
                                highp float _9280 = _8321 - _8327;
                                ...
                                {
                                    highp float _9285 = _9278 * _8321;
                                    highp float _9286 = (_9280 * _9280) - _9285;
                                    ...
                                    else
                                    {
                                        ...
                                        highp float _9298 = _9269;
                                        _9269 = _9290 / _9278;
                                        _9270 = _9298;
                                    }
                                }
                                highp float _9321 = (_8318 - _8325) * 2.0;
                                _8274 = vec2(((((_9275 * _9269) - _9321) * _9269) + _8318) * _7985, ((((_9275 * _9270) - _9321) * _9270) + _8318) * _7985);
                            }
                            else
                            {
                                highp float _9196 = (_8318 - (_8325 * 2.0)) + _8331;
                                highp float _9199 = (_8321 - (_8327 * 2.0)) + _8333;
                                highp float _9200 = _8318 - _8325;
                                ...
                                {
                                    highp float _9206 = _9196 * _8318;
                                    highp float _9207 = (_9200 * _9200) - _9206;
                                    ...
                                    else
                                    {
                                        ...
                                        highp float _9219 = _9190;
                                        _9190 = _9211 / _9196;
                                        _9191 = _9219;
                                    }
                                }
                                highp float _9242 = (_8321 - _8327) * 2.0;
                        ...
                        if (_12477 == 3)
                        {
                            highp float _8398 = _12478.x - _12863.x;
                            highp float _8401 = _12478.y - _12863.y;
                            highp float _8405 = _12480.x - _12863.x;
                            highp float _8407 = _12480.y - _12863.y;
                            do
                            {
                                if (true)
                                {
                                ...
                                highp float _8427 = _8276 - _8275;
                                if (abs(_8427) < 1.0000000133514319600180897396058e-10)
                                {
                                    break;
                                }
                                highp float _8435 = clamp((-_8275) / _8427, 0.0, 1.0);
                                if (true)
                                {
                                    _8277 = _8407 - _8401;
                                }
                                ...
                                highp float _8455 = _8272;
                                highp float _8456 = _8455 * _7985;
                                if (_8277 > 0.0)
                                {
                                    _8272 = 1.0;
                                }
                        ...
                        if (_12477 == 1)
                        {
                            do
                            {
                                ...
                                highp float _8554 = _12482.x * (_8277 - _8275);
                                highp float _8559 = _12482.y * (_8278 - _8275);
                                highp float _8564 = _12482.z * (_8279 - _8275);
                                ...
                                highp float _8575 = (_8554 - (2.0 * _8559)) + _8564;
                                highp float _8576 = _8559 - _8554;
                                highp float _8577 = 2.0 * _8576;
                                if (abs(_8575) < 1.52587890625e-05)
                                {
                                    ...
                                    highp float _8601 = _8280;
                                    _8280 = 0.0;
                                    _8284 = _8601;
                                }
                                else
                                {
                                    highp float _8586 = sqrt(max((_8577 * _8577) - ((4.0 * _8575) * _8554), 0.0));
                                    highp float _8587 = 0.5 / _8575;
                                    highp float _8588 = _8576 * (-2.0);
                                    _8288 = 2;
                                ...
                                highp float _8635 = _8277 * _12482.x;
                                highp float _8642 = (_8635 - ((2.0 * _8278) * _12482.y)) + (_8279 * _12482.z);
                                highp float _8646 = 2.0 * ((_8278 * _12482.y) - _8635);
                                highp float _8648 = _8281 * _12482.x;
                                highp float _8655 = (_8648 - ((2.0 * _8282) * _12482.y)) + (_8283 * _12482.z);
                                highp float _8659 = 2.0 * ((_8282 * _12482.y) - _8648);
                                highp float _8662 = (_12482.x - (2.0 * _12482.y)) + _12482.z;
                                highp float _8664 = 2.0 * (_12482.y - _12482.x);
                                highp float _8687;
                                highp float _8691;
                                do
                                {
                                    highp float _8673 = max((((_8662 * _8285) + _8664) * _8285) + _12482.x, 1.52587890625e-05);
                                    _8687 = 2.0 * _8642;
                                    _8691 = 2.0 * _8662;
                                    highp float _8699 = ((((_8687 * _8285) + _8646) * _8673) - (((((_8642 * _8285) + _8646) * _8285) + _8635) * ((_8691 * _8285) + _8664))) / (_8673 * _8673);
                                    if (false)
                                    {
                                        _8291 = -_8699;
                                    }
                                    ...
                                    highp float _8712 = ((((((_8655 * _8285) + _8659) * _8285) + _8648) / _8673) - _8276) * _7985;
                                    if (_8291 > 0.0)
                                    {
                                        _8272 = 1.0;
                                    }
                                ...
                                if (_8289 == 2)
                                {
                                    do
                                    {
                                        highp float _8742 = max((((_8662 * _8286) + _8664) * _8286) + _12482.x, 1.52587890625e-05);
                                        highp float _8766 = ((((_8687 * _8286) + _8646) * _8742) - (((((_8642 * _8286) + _8646) * _8286) + _8635) * ((_8691 * _8286) + _8664))) / (_8742 * _8742);
                                        if (false)
                                        {
                                            _8291 = -_8766;
                                        }
                                        ...
                                        highp float _8778 = ((((((_8655 * _8286) + _8659) * _8286) + _8648) / _8742) - _8276) * _7985;
                                        if (_8291 > 0.0)
                                        {
                                            _8272 = 1.0;
                                        }
                        ...
                        do
                        {
                            ...
                            highp float _8891 = 3.0 * _8278;
                            highp float _8894 = 3.0 * _8279;
                            highp float _8897 = ((_8891 - _8277) - _8894) + _8280;
                            highp float _8903 = ((3.0 * _8277) - (6.0 * _8278)) + _8894;
                            highp float _8906 = ((-3.0) * _8277) + _8891;
                            highp float _8909 = _8277 - _8275;
                            highp float _8912 = _8280 - _8275;
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    do
                                    {
                                        ...
                                        highp float _9701 = 0.5;
                                        highp float _9702 = 0.0;
                                        highp float _9703 = 1.0;
                                        int _9704 = 0;
                                        for (;;)
                                        {
                                            if (!(_9704 < 16))
                                            ...
                                            highp float _9745 = (((((_8897 * _9701) + _8903) * _9701) + _8906) * _9701) + _8909;
                                            if (_9728)
                                            {
                                                _9700 = _9745 < 0.0;
                                            }
                                            ...
                                            highp float _9772 = ((((3.0 * _8897) * _9701) + (2.0 * _8903)) * _9701) + _8906;
                                            highp float _9776 = (_9702 + _9703) * 0.5;
                                            if (abs(_9772) >= 9.9999999747524270787835121154785e-07)
                                            {
                                                highp float _9783 = _9701 - (_9745 / _9772);
                                                if (_9783 > _9702)
                                                {
                                                    _9707 = _9783 < _9703;
                                                }
                            ...
                            highp float _8937 = 3.0 * _8282;
                            highp float _8940 = 3.0 * _8283;
                            if (_8292 == 1.0)
                            {
                                _8285 = _8284;
                            }
                            ...
                            highp float _8981 = (_8285 - _8276) * _7985;
                            if (_8286 > 0.0)
                            {
                                _8272 = 1.0;
                            }
        ...
        highp vec2 _8132 = vec2(_8054, _8055);
        highp float _7989 = _3248.y;
        int _7990 = _3335 + 1;
        highp float _9806 = 0.0;
        highp float _9807 = 0.0;
        ...
        for (;;)
        {
            ...
            for (;;)
            {
                ...
                do
                {
                    ...
                    highp vec4 _9958 = texelFetch(SPIRV_Cross_Combinedu_curve_texSPIRV_Cross_DummySampler, ivec4(_9946, _3277, 0).xyz, 0);
                    int _9996 = _9946.x + 1;
                    ivec2 _9998 = ivec2(_9996, _9946.y);
                    _9998.y = _9998.y + (_9996 >> 12);
                    _9998.x = _9998.x & 4095;
                    highp vec4 _9964 = texelFetch(SPIRV_Cross_Combinedu_curve_texSPIRV_Cross_DummySampler, ivec4(_9998, _3277, 0).xyz, 0);
                    int _12401 = _9951;
                    highp vec2 _12402 = _9958.xy;
                    highp vec2 _12403 = _9958.zw;
                    highp vec2 _12404 = _9964.xy;
                    highp vec2 _12405 = _9964.zw;
                    if (_9951 == 1)
                    {
                    ...
                    int _12433 = _12401;
                    highp vec2 _12434 = _12402;
                    highp vec2 _12435 = _12403;
                    highp vec2 _12436 = _12404;
                    highp vec2 _12437 = _12405;
                    highp vec3 _12438 = _12406;
                    do
                    {
                        if (false)
                        {
                        ...
                        if (_12433 == 0)
                        {
                            highp float _10070 = _12434.x - _12863.x;
                            highp float _10073 = _12434.y - _12863.y;
                            highp float _10077 = _12435.x - _12863.x;
                            highp float _10079 = _12435.y - _12863.y;
                            highp float _10083 = _12436.x - _12863.x;
                            highp float _10085 = _12436.y - _12863.y;
                            if (false)
                            {
                            ...
                            if (false)
                            {
                                highp float _11027 = (_10070 - (_10077 * 2.0)) + _10083;
                                highp float _11030 = (_10073 - (_10079 * 2.0)) + _10085;
                                highp float _11032 = _10073 - _10079;
                                ...
                                {
                                    highp float _11037 = _11030 * _10073;
                                    highp float _11038 = (_11032 * _11032) - _11037;
                                    ...
                                    if (_11032 >= 0.0)
                                    {
                                        highp float _11052 = _11032 + _11087;
                                    ...
                                    {
                                        highp float _11042 = _11032 - _11087;
                                        ...
                                        highp float _11050 = _11021;
                                        _11021 = _11042 / _11030;
                                        _11022 = _11050;
                                    }
                                }
                                highp float _11073 = (_10070 - _10077) * 2.0;
                                _10026 = vec2(((((_11027 * _11021) - _11073) * _11021) + _10070) * _7989, ((((_11027 * _11022) - _11073) * _11022) + _10070) * _7989);
                            }
                            else
                            {
                                highp float _10948 = (_10070 - (_10077 * 2.0)) + _10083;
                                highp float _10951 = (_10073 - (_10079 * 2.0)) + _10085;
                                highp float _10952 = _10070 - _10077;
                                ...
                                {
                                    highp float _10958 = _10948 * _10070;
                                    highp float _10959 = (_10952 * _10952) - _10958;
                                    ...
                                    if (_10952 >= 0.0)
                                    {
                                        highp float _10973 = _10952 + _11008;
                                    ...
                                    {
                                        highp float _10963 = _10952 - _11008;
                                        ...
                                        highp float _10971 = _10942;
                                        _10942 = _10963 / _10948;
                                        _10943 = _10971;
                                    }
                                }
                                highp float _10994 = (_10073 - _10079) * 2.0;
                        ...
                        if (_12433 == 3)
                        {
                            highp float _10150 = _12434.x - _12863.x;
                            highp float _10153 = _12434.y - _12863.y;
                            highp float _10157 = _12436.x - _12863.x;
                            highp float _10159 = _12436.y - _12863.y;
                            do
                            {
                                if (false)
                                {
                                ...
                                highp float _10179 = _10028 - _10027;
                                if (abs(_10179) < 1.0000000133514319600180897396058e-10)
                                {
                                    break;
                                }
                                highp float _10187 = clamp((-_10027) / _10179, 0.0, 1.0);
                                if (false)
                                {
                                ...
                                highp float _10207 = _10024;
                                highp float _10208 = _10207 * _7989;
                                if (_10029 > 0.0)
                                {
                                    _10024 = 1.0;
                                }
                        ...
                        if (_12433 == 1)
                        {
                            do
                            {
                                ...
                                highp float _10306 = _12438.x * (_10029 - _10027);
                                highp float _10311 = _12438.y * (_10030 - _10027);
                                highp float _10316 = _12438.z * (_10031 - _10027);
                                ...
                                highp float _10327 = (_10306 - (2.0 * _10311)) + _10316;
                                highp float _10328 = _10311 - _10306;
                                highp float _10329 = 2.0 * _10328;
                                if (abs(_10327) < 1.52587890625e-05)
                                {
                                    ...
                                    highp float _10353 = _10032;
                                    _10032 = 0.0;
                                    _10036 = _10353;
                                }
                                else
                                {
                                    highp float _10338 = sqrt(max((_10329 * _10329) - ((4.0 * _10327) * _10306), 0.0));
                                    highp float _10339 = 0.5 / _10327;
                                    highp float _10340 = _10328 * (-2.0);
                                    _10040 = 2;
                                ...
                                highp float _10387 = _10029 * _12438.x;
                                highp float _10394 = (_10387 - ((2.0 * _10030) * _12438.y)) + (_10031 * _12438.z);
                                highp float _10398 = 2.0 * ((_10030 * _12438.y) - _10387);
                                highp float _10400 = _10033 * _12438.x;
                                highp float _10407 = (_10400 - ((2.0 * _10034) * _12438.y)) + (_10035 * _12438.z);
                                highp float _10411 = 2.0 * ((_10034 * _12438.y) - _10400);
                                highp float _10414 = (_12438.x - (2.0 * _12438.y)) + _12438.z;
                                highp float _10416 = 2.0 * (_12438.y - _12438.x);
                                highp float _10439;
                                highp float _10443;
                                do
                                {
                                    highp float _10425 = max((((_10414 * _10037) + _10416) * _10037) + _12438.x, 1.52587890625e-05);
                                    _10439 = 2.0 * _10394;
                                    _10443 = 2.0 * _10414;
                                    highp float _10451 = ((((_10439 * _10037) + _10398) * _10425) - (((((_10394 * _10037) + _10398) * _10037) + _10387) * ((_10443 * _10037) + _10416))) / (_10425 * _10425);
                                    if (true)
                                    {
                                        _10043 = -_10451;
                                    }
                                    ...
                                    highp float _10464 = ((((((_10407 * _10037) + _10411) * _10037) + _10400) / _10425) - _10028) * _7989;
                                    if (_10043 > 0.0)
                                    {
                                        _10024 = 1.0;
                                    }
                                ...
                                if (_10041 == 2)
                                {
                                    do
                                    {
                                        highp float _10494 = max((((_10414 * _10038) + _10416) * _10038) + _12438.x, 1.52587890625e-05);
                                        highp float _10518 = ((((_10439 * _10038) + _10398) * _10494) - (((((_10394 * _10038) + _10398) * _10038) + _10387) * ((_10443 * _10038) + _10416))) / (_10494 * _10494);
                                        if (true)
                                        {
                                            _10043 = -_10518;
                                        }
                                        ...
                                        highp float _10530 = ((((((_10407 * _10038) + _10411) * _10038) + _10400) / _10494) - _10028) * _7989;
                                        if (_10043 > 0.0)
                                        {
                                            _10024 = 1.0;
                                        }
                        ...
                        do
                        {
                            ...
                            highp float _10643 = 3.0 * _10030;
                            highp float _10646 = 3.0 * _10031;
                            highp float _10649 = ((_10643 - _10029) - _10646) + _10032;
                            highp float _10655 = ((3.0 * _10029) - (6.0 * _10030)) + _10646;
                            highp float _10658 = ((-3.0) * _10029) + _10643;
                            highp float _10661 = _10029 - _10027;
                            highp float _10664 = _10032 - _10027;
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    do
                                    {
                                        ...
                                        highp float _11453 = 0.5;
                                        highp float _11454 = 0.0;
                                        highp float _11455 = 1.0;
                                        int _11456 = 0;
                                        for (;;)
                                        {
                                            if (!(_11456 < 16))
                                            ...
                                            highp float _11497 = (((((_10649 * _11453) + _10655) * _11453) + _10658) * _11453) + _10661;
                                            if (_11480)
                                            {
                                                _11452 = _11497 < 0.0;
                                            }
                                            ...
                                            highp float _11524 = ((((3.0 * _10649) * _11453) + (2.0 * _10655)) * _11453) + _10658;
                                            highp float _11528 = (_11454 + _11455) * 0.5;
                                            if (abs(_11524) >= 9.9999999747524270787835121154785e-07)
                                            {
                                                highp float _11535 = _11453 - (_11497 / _11524);
                                                if (_11535 > _11454)
                                                {
                            ...
                            highp float _10689 = 3.0 * _10034;
                            highp float _10692 = 3.0 * _10035;
                            if (_10044 == 1.0)
                            {
                                _10037 = _10036;
                            }
                            ...
                            highp float _10733 = (_10037 - _10028) * _7989;
                            if (_10038 > 0.0)
                            {
                                _10024 = 1.0;
                            }
        ...
        highp vec2 _9884 = vec2(_9806, _9807);
        highp float _7994 = _8132.y;
        highp float _7995 = _9884.y;
        highp float _7997 = _8132.x;
        highp float _7999 = _9884.x;
        highp float _8003 = ((_7997 * _7994) + (_7999 * _7995)) / max(_7994 + _7995, 1.52587890625e-05);
        highp float _11559;
        do
        {
            if (_3332 == 1)
        ...
        highp float _11612 = clamp(max(_11559, min(_11576, _11593)), 0.0, 1.0);
        highp float _11613 = max(_12872, 1.52587890625e-05);
        highp float _11609;
        ...
        do
        {
            ...
            highp vec4 _11636 = texelFetch(SPIRV_Cross_Combinedu_layer_texSPIRV_Cross_DummySampler, ivec3(ivec2(_11768 - _11763 * (_11768 / _11763), _11768 / _11763), 0).xy, 0);
            if (_11631 == 1)
            {
                _12377 = _11636;
                _12378 = 0.0;
            ...
            highp vec4 _11646 = texelFetch(SPIRV_Cross_Combinedu_layer_texSPIRV_Cross_DummySampler, ivec3(ivec2(_11792 - _11787 * (_11792 / _11787), _11792 / _11787), 0).xy, 0);
            ...
            highp vec4 _11652 = texelFetch(SPIRV_Cross_Combinedu_layer_texSPIRV_Cross_DummySampler, ivec3(ivec2(_11810 - _11805 * (_11810 / _11805), _11810 / _11805), 0).xy, 0);
            if (_11631 == 2)
            {
                highp vec2 _11657 = _11636.xy;
                highp vec2 _11658 = _11636.zw - _11657;
                highp float _11659 = dot(_11658, _11658);
                highp float _11624;
                ...
                do
                {
                    ...
                    if (_11839 == 2)
                    {
                        highp float _11849 = _11624 - (2.0 * floor(_11624 * 0.5));
                        highp float _11834;
                        if (_11849 < 0.0)
                        {
                            _11834 = _11849 + 2.0;
            ...
            if (_11631 == 3)
            {
                highp float _11687 = length(_12863 - _11636.xy) / max(abs(_11636.z), 1.52587890625e-05);
                highp float _11874;
                do
                {
                    ...
                    if (_11880 == 2)
                    {
                        highp float _11890 = _11687 - (2.0 * floor(_11687 * 0.5));
                        highp float _11875;
                        if (_11890 < 0.0)
                        {
                            _11875 = _11890 + 2.0;
            ...
            if (_11631 == 6)
            {
                highp vec2 _11696 = _12863 - _11636.xy;
                highp float _11701 = atan(_11696.y, _11696.x) - _11636.z;
                highp float _11702 = _11701 * 0.15915493667125701904296875;
                highp float _11915;
                do
                {
                    ...
                    if (_11921 == 2)
                    {
                        highp float _11931 = _11702 - (2.0 * floor(_11701 * 0.079577468335628509521484375));
                        highp float _11916;
                        if (_11931 < 0.0)
                        {
                            _11916 = _11931 + 2.0;
            ...
            if (_11631 == 4)
            {
                ...
                highp vec4 _11714 = texelFetch(SPIRV_Cross_Combinedu_layer_texSPIRV_Cross_DummySampler, ivec3(ivec2(_11969 - _11964 * (_11969 / _11964), _11969 / _11964), 0).xy, 0);
                ...
                highp vec4 _11720 = texelFetch(SPIRV_Cross_Combinedu_layer_texSPIRV_Cross_DummySampler, ivec3(ivec2(_11987 - _11982 * (_11987 / _11982), _11987 / _11982), 0).xy, 0);
                highp vec3 _11722 = vec3(_12863, 1.0);
                highp float _11727 = dot(_11722, vec3(_11636.xyz));
                highp float _11732 = dot(_11722, vec3(_11714.xyz));
                highp float _11992;
                do
                {
                    ...
                    if (_11998 == 2)
                    {
                        highp float _12008 = _11727 - (2.0 * floor(_11727 * 0.5));
                        highp float _11993;
                        if (_12008 < 0.0)
                        {
                            _11993 = _12008 + 2.0;
                ...
                do
                {
                    ...
                    if (_12029 == 2)
                    {
                        highp float _12039 = _11732 - (2.0 * floor(_11732 * 0.5));
                        highp float _12024;
                        if (_12039 < 0.0)
                        {
                            _12024 = _12039 + 2.0;
                ...
                highp vec2 _11741 = vec2(_11992 * _11720.x, _12023 * _11720.y);
        ...
        highp vec4 _3350 = _12377 * _12862;
        highp float _12108 = _3350.w * _11609;
        highp vec4 _12111 = vec4(_3350.xyz * _12108, _12108);
        if (_12378 > 0.5)
        {
            highp vec4 _12113;
            do
            {
                highp float _12118 = _12111.w;
                bool _12114;
                if (_12118 <= 0.0)
                {
                    _12114 = true;
                ...
                highp float _12150 = max(_12111.x, 0.0);
                highp float _12159;
                ...
                highp float _12153 = max(_12111.y, 0.0);
                highp float _12171;
                ...
                highp float _12156 = max(_12111.z, 0.0);
                highp float _12183;
                ...
                highp vec3 _12136 = clamp(vec3(_12159, _12171, _12183) + vec3((fract(52.98291778564453125 * fract(dot(gl_FragCoord.xy, vec2(0.067110560834407806396484375, 0.005837149918079376220703125)))) - 0.5) * (clamp(_12118, 0.0, 1.0) * _12873)), vec3(0.0), vec3(1.0));
                highp float _12197 = _12136.x;
                highp float _12204;
        ...
        else
        {
            if (_12871 != 0)
            {
                ...
                do
                {
                    ...
                    highp vec3 _12251 = _3238.xyz * (1.0 / _3238.w);
                    highp float _12260 = max(_12251.x, 0.0);
                    highp float _12269;
                    ...
                    highp float _12263 = max(_12251.y, 0.0);
                    highp float _12281;
                    ...
                    highp float _12266 = max(_12251.z, 0.0);
                    highp float _12293;
