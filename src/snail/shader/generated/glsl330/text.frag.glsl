...
void main()
{
    vec4 _2154 = snail_io0;
    vec4 _2155 = snail_io4;
    vec2 _2156 = snail_io1;
    vec4 _2157 = snail_io2;
    ...
    vec2 _1167 = fwidth(_2156);
    float _1131 = 1.0 / max(_1167.x, 1.52587890625e-05);
    float _1134 = 1.0 / max(_1167.y, 1.52587890625e-05);
    int _1137 = snail_io3.w & 255;
    float _1352 = (_2156.y * _2157.y) + _2157.w;
    float _1356 = max(abs(_1167.y * _2157.y) * 0.5, 9.9999997473787516355514526367188e-06);
    int _1359 = clamp(int(_1352 - _1356), 0, snail_io3.z);
    int _1363 = max(_1359, clamp(int(_1352 + _1356), 0, snail_io3.z));
    float _1374 = (_2156.x * _2157.x) + _2157.z;
    float _1378 = max(abs(_1167.x * _2157.x) * 0.5, 9.9999997473787516355514526367188e-06);
    ...
    for (;;)
    {
        ...
        for (;;)
        {
            ...
            do
            {
                ...
                do
                {
                    vec4 _1471 = texelFetch(SPIRV_Cross_Combinedu_curve_texSPIRV_Cross_DummySampler, ivec4(_1462, _1125, 0).xyz, 0);
                    int _1540 = _1462.x + 1;
                    ivec2 _1542 = ivec2(_1540, _1462.y);
                    _1542.y = _1542.y + (_1540 >> 12);
                    _1542.x = _1542.x & 4095;
                    vec4 _1483 = vec4(_1471.xy, _1471.zw) - vec4(_2156, _2156);
                    vec2 _1485 = texelFetch(SPIRV_Cross_Combinedu_curve_texSPIRV_Cross_DummySampler, ivec4(_1542, _1125, 0).xyz, 0).xy - _2156;
                    ...
                    if (_1570 != 0u)
                    {
                        vec2 _1602 = _1483.xy;
                        vec2 _1603 = _1483.zw;
                        vec2 _1606 = (_1602 - (_1603 * 2.0)) + _1485;
                        vec2 _1607 = _1602 - _1603;
                        float _1608 = _1606.y;
                        ...
                        else
                        {
                            float _1612 = _1607.y;
                            float _1614 = _1483.y;
                            float _1615 = _1608 * _1614;
                            float _1616 = (_1612 * _1612) - _1615;
                        ...
                        float _1651 = _1606.x;
                        float _1655 = _1607.x * 2.0;
                        float _1659 = _1483.x;
                        vec2 _1503 = vec2((((_1651 * _1598) - _1655) * _1598) + _1659, (((_1651 * _1599) - _1655) * _1599) + _1659) * _1131;
                        if ((_1570 & 1u) != 0u)
                        {
                            float _1507 = _1503.x;
    ...
    for (;;)
    {
        ...
        for (;;)
        {
            ...
            do
            {
                ...
                do
                {
                    vec4 _1759 = texelFetch(SPIRV_Cross_Combinedu_curve_texSPIRV_Cross_DummySampler, ivec4(_1750, _1125, 0).xyz, 0);
                    int _1828 = _1750.x + 1;
                    ivec2 _1830 = ivec2(_1828, _1750.y);
                    _1830.y = _1830.y + (_1828 >> 12);
                    _1830.x = _1830.x & 4095;
                    vec4 _1771 = vec4(_1759.xy, _1759.zw) - vec4(_2156, _2156);
                    vec2 _1773 = texelFetch(SPIRV_Cross_Combinedu_curve_texSPIRV_Cross_DummySampler, ivec4(_1830, _1125, 0).xyz, 0).xy - _2156;
                    ...
                    if (_1857 != 0u)
                    {
                        vec2 _1889 = _1771.xy;
                        vec2 _1890 = _1771.zw;
                        vec2 _1893 = (_1889 - (_1890 * 2.0)) + _1773;
                        vec2 _1894 = _1889 - _1890;
                        float _1895 = _1893.x;
                        ...
                        else
                        {
                            float _1899 = _1894.x;
                            float _1901 = _1771.x;
                            float _1902 = _1895 * _1901;
                            float _1903 = (_1899 * _1899) - _1902;
                        ...
                        float _1938 = _1893.y;
                        float _1942 = _1894.y * 2.0;
                        float _1946 = _1771.y;
                        vec2 _1791 = vec2((((_1938 * _1885) - _1942) * _1885) + _1946, (((_1938 * _1886) - _1942) * _1886) + _1946) * _1134;
                        if ((_1857 & 1u) != 0u)
                        {
                            float _1795 = _1791.x;
    ...
    float _1340 = ((_1168 * _1169) + (_1173 * _1174)) / max(_1169 + _1174, 1.52587890625e-05);
    float _1969;
    do
    {
        if (false)
    ...
    float _2022 = clamp(max(_1969, min(_1986, _2003)), 0.0, 1.0);
    float _2023 = max(pc.coverage_exponent, 1.52587890625e-05);
    float _2019;
    ...
    vec4 _1150 = _2154 * _2155;
    float _2035 = _1150.w * _2019;
    vec4 _2038 = vec4(_1150.xyz * _2035, _2035);
    vec4 _1114;
    if (pc.mask_output != 0)
    {
        _1114 = vec4(_2038.w);
    ...
    else
    {
        if (pc.output_srgb != 0)
        {
            ...
            do
            {
                ...
                vec3 _2050 = _2038.xyz * (1.0 / _2044);
                float _2060 = max(_2050.x, 0.0);
                float _2069;
