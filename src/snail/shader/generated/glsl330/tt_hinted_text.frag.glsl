...
ivec2 offsetTtHintedInfoLoc_0_u0028_t21_u003b_vi2_u003b_i1_u003b(sampler2D layer_tex_0_, inout ivec2 base_0_, inout int offset_0_) {
    uint uw_0_ = 0u;
    int width_0_ = 0;
    int texel_0_ = 0;
    int _S1_ = 0;
