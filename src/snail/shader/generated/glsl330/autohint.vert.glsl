...
uniform sampler2D _group_0_binding_3_vs;
...
float snailWarpF_0_u0028_t21_u003b_vi2_u003b_i1_u003b_i1_u003b(sampler2D layer_tex_1_, inout ivec2 info_base_0_, inout int block_0_, inout int i_1_) {
    int f_0_ = 0;
    ivec2 _S33_ = ivec2(0);
    ivec2 param = ivec2(0);
    int param_1 = 0;
