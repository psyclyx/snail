...
const transform_mod = @import("text/transform.zig");
...
pub const track = transform_mod.track;
pub const shiftBaseline = transform_mod.shiftBaseline;
pub const spaceWords = transform_mod.spaceWords;
pub const snapAdvances = transform_mod.snapAdvances;
...
pub const TrueTypePreparedHintGlyph = hint_context_mod.PreparedHintRun.Glyph;
pub const TrueTypePreparedHintRun = hint_context_mod.PreparedHintRun;
pub const TrueTypeHintRunStats = hint_context_mod.PreparedHintRun.Stats;
...
pub const TextCellGrid = types_mod.TextCellGrid;
pub const TextCellGridOptions = types_mod.TextCellGridOptions;
