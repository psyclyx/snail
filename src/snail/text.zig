...
const hint_snapshot_mod = @import("text/hint_snapshot.zig");
...
pub const TrueTypeHintCacheFootprint = hint_context_mod.TrueTypeHintContext.Footprint;
pub const TrueTypeHintSizeKeyEntry = hint_context_mod.TrueTypeHintContext.SizeKeyEntry;
pub const TrueTypeHintSizeKeyIterator = hint_context_mod.TrueTypeHintContext.SizeKeyIterator;
pub const TrueTypeHintGlyphKeyEntry = hint_context_mod.TrueTypeHintContext.GlyphKeyEntry;
pub const TrueTypeHintGlyphKeyIterator = hint_context_mod.TrueTypeHintContext.GlyphKeyIterator;
...
pub const GlyphHintSnapshot = hint_snapshot_mod.GlyphHintSnapshot;
pub const GlyphHintSnapshotBuilderOptions = hint_snapshot_mod.BuilderOptions;
