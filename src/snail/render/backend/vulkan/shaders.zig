...
const raw_vert_replicated = @embedFile("snail_replicated.vert.spv");
...
const raw_frag_hinted_text = @embedFile("snail_hinted_text.frag.spv");
...
const aligned_vert_replicated: [raw_vert_replicated.len]u8 align(4) = raw_vert_replicated.*;
...
const aligned_frag_hinted_text: [raw_frag_hinted_text.len]u8 align(4) = raw_frag_hinted_text.*;
...
pub const vert_replicated_spv: []align(4) const u8 = &aligned_vert_replicated;
...
pub const frag_hinted_text_spv: []align(4) const u8 = &aligned_frag_hinted_text;
