// Shared GLSL assembled for the GLES backend.
...
const gles_vert_interface = @embedFile("../glsl/snail_vert.interface.glsl");
const gles_frag_interface = @embedFile("../glsl/snail_frag.interface.glsl");
const gles_text_subpixel_interface = @embedFile("../glsl/snail_text_subpixel.interface.glsl");
const gles_text_coverage_interface = @embedFile("../glsl/snail_text_coverage.interface.glsl");
const gles_text_sample_interface = @embedFile("../glsl/snail_text_sample.interface.glsl");
...
pub const text_vertex_interface = gles_vert_interface;
pub const text_fragment_interface = gles_text_subpixel_interface;
pub const text_coverage_fragment_interface = gles_text_coverage_interface;
pub const text_sample_interface = gles_text_sample_interface;
