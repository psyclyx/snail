...
pub const TrueTypeHintRunKeys = text.TrueTypeHintRunKeys;
pub const TrueTypeHintRunAvailability = text.TrueTypeHintRunAvailability;
pub const TextHintRunPlan = text.TextHintRunPlan;
pub const HintedPlacement = text.HintedPlacement;
pub const HintPlanStats = text.HintPlanStats;
pub const TextHintPlanOptions = text.TextHintPlanOptions;
pub const TextHintUploadOp = text.TextHintUploadOp;
pub const TextHintGlyphRecord = text.TextHintGlyphRecord;
pub const TextHintHandle = text.TextHintHandle;
...
pub const gatherTrueTypeHintRunKeys = text.gatherTrueTypeHintRunKeys;
pub const planHintedRun = text.planHintedRun;
