...
pub const TextBatchAppend = text.TextBatchAppend;
...
pub const GlCoverageBindings = coverage.GlBindings;
pub const VulkanCoverageBindings = coverage.VulkanBindings;
pub const CoverageBindings = coverage.Bindings;
pub const CoverageShader = coverage.Shader;
pub const GlCoverageProgram = coverage.GlProgram;
pub const VulkanCoverageProgram = coverage.VulkanProgram;
pub const CpuCoverageProgram = coverage.CpuProgram;
pub const CoverageProgram = coverage.Program;
